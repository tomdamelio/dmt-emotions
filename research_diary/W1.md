...
[ ] Corregir porque por algun motivo no me esta procesando los sujetos 02 y 03. Directamente del sujeto 1 me pasa al 4. y sospecho que no me esta revisando todos losa archivos. Sera que primero me hace todos los los y despues me hace todos los high? No entiendo bien que pasa, pero si solucionar esto no puedo seguir (no puedo correr `test_phys_preprocessing.py` sin corrobroar que estoy anotando bien). 
